...
import { CircleDashedIcon, CircleIcon, type LucideIcon } from "lucide-react";
...
export const StatusCombobox = ({
  ...
  const [selectedStatus, setSelectedStatus] = React.useState<
    Status | undefined
  >(statuses.find((p) => p.value === defaultStatus));
            ...
            <CommandGroup>
              {statuses.map((status, index) => (
                <CommandItem
                  ...
                  value={status.value}
                  onSelect={(value) => {
                    setSelectedStatus(statuses.find((p) => p.value === value));
                    setOpenTooltip(false);
                    setOpenPopover(false);
                    setSearchValue("");
                  }}
